// Auto-generated. Per-entity form-enhancements config for "Wartungsprotokolle".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['titel', 'wartungsart', 'datum_wartung', 'naechste_wartung', 'kosten', 'techniker', 'status', 'notizen'],
  defaults: {
